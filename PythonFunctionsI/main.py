...
def problem_two(name_one, name_two):
    result = name_one + name_two
    return result

result = problem_two("Joe ", "Oliveira ")
print(result)
...
def problem_three(first_name):
    for char in first_name:
        print(char)
        
problem_three("Joseph")
...
def problem_four(middle_name):
    while True:
        problem_four = middle_name
